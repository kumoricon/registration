            ...
            try {
                ...
                for (InLineRegistrationAttendee a : order.getAttendees()) {
                    ...
                    try {
                        ...
                        ilr.setFirstName(a.getFirstName().strip());
                        ilr.setLastName(a.getLastName().strip());
                        ilr.setLegalFirstName(a.getFirstNameOnId().strip());
                        ilr.setLegalLastName(a.getLastNameOnId().strip());
                        ...
                        ilr.setPhoneNumber(a.getPhone().strip());
                        ilr.setEmail(a.getEmail().strip());
                        ilr.setBirthDate(LocalDate.of(a.getBirthYear(), a.getBirthMonth(), a.getBirthDay()));
                        ilr.setEmergencyContactFullName(a.getEmergencyName().strip());
                        ilr.setEmergencyContactPhone(a.getEmergencyPhone().strip());
                        ilr.setParentIsEmergencyContact(!a.getParentContactSeparate());
                        ilr.setParentFullName(a.getParentName().strip());
                        ilr.setParentPhone(a.getParentPhone().strip());

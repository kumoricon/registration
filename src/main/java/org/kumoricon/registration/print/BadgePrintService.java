    ...
    List<StaffBadgeDTO> staffBadgeDTOsFromStaff(@NotNull List<Staff> staffList) {
        ...
        for (Staff s : staffList) {
            StaffBadgeDTO sb = new StaffBadgeDTO.Builder()
                    .withFirstName(s.getNamePrivacyFirst()) // Note: Staff's privacy name gets used on the badge
                    .withLastName(s.getNamePrivacyLast())   // rather than their preferred first/last name
